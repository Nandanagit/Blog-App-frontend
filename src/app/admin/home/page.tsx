...
export default function AdminHomePage() {
  ...
  const fetchPosts = async (): Promise<void> => {
    try {
      const response = await fetch('https://blog-nandana-backend.vercel.app/admin/posts', {
        headers: {
  ...
  const createPost = async (postData: NewPostData): Promise<void> => {
    try {
      const response = await fetch('https://blog-nandana-backend.vercel.app/admin/post', {
        method: 'POST',
        headers: {
          'Authorization': 'Bearer ' + localStorage.getItem('jwt_token'),
  ...
  const updatePost = async (postId: string, updates: { title: string; body: string }): Promise<void> => {
    try {
      const response = await fetch(`https://blog-nandana-backend.vercel.app/admin/post/${postId}`, {
        method: 'PUT',
        headers: {
          'Authorization': 'Bearer ' + localStorage.getItem('jwt_token'),
          'Content-Type': 'application/json',
  ...
  const deletePost = async (postId: string): Promise<void> => {
    try {
                          await fetch(`https://blog-nandana-backend.vercel.app/admin/post/${postId}`, {
                            method: 'DELETE',
                            headers: {
                              'Authorization': 'Bearer ' + localStorage.getItem('jwt_token'),
                              'Content-Type': 'application/json',
  ...
  const fetchUsers = async (): Promise<void> => {
    try {
      const response = await fetch('https://blog-nandana-backend.vercel.app/admin/users', {
        headers: {
          'Authorization': 'Bearer ' + localStorage.getItem('jwt_token'),
          'Content-Type': 'application/json',
        },
  ...
  const updateUser = async (_: string, updates: UpdateUserData): Promise<void> => {
    try {
      const response = await fetch(`https://blog-nandana-backend.vercel.app/admin/user/${updates.id}`, {
        method: 'PUT',
        headers: {
          'Authorization': 'Bearer ' + localStorage.getItem('jwt_token'),
          'Content-Type': 'application/json',
  ...
  const deleteUser = async (_id: string): Promise<void> => {
    try {
      const response = await fetch(`https://blog-nandana-backend.vercel.app/admin/user/${_id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': 'Bearer ' + localStorage.getItem('jwt_token'),
          'Content-Type': 'application/json',
